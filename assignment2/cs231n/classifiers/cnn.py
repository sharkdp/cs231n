...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        # self.params. Store weights and biases for the convolutional layer
        # using the keys 'W1' and 'b1'; use keys 'W2' and 'b2' for the weights
    ...
    def loss(self, X, y=None):
        ...
        # net, storing the loss and gradients in the loss and grads variables.
